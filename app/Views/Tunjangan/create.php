...
<div class="container pt-5">
    ...
    <div class="card">
        <div class="card-header bg-primary text-white">
            <h4 class="card-title">Tambah Tunjangan Baru</h4>
        </div>
        ...
        <div class="card-body">
            <form action="<?= base_url('tunjangan/store') ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="jumlah_tunjangan" name="jumlah_tunjangan">
                </div>
                <div class="form-group">
                    <label for="tunjangan_suami_istri">Tunjangan Suami/Istri</label>
                    <input type="number" class="form-control" id="tunjangan_suami_istri" name="tunjangan_suami_istri">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="sewa_rumah" name="sewa_rumah">
                </div>
